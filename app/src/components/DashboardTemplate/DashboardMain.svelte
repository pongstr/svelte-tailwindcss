<script lang="ts">
  ...
  import { Pongstr } from '@/components/atoms'
...
<div class="dashboard">
  <header>
    ...
    <div class="header-settings pb-4">
...
<style lang="postcss" global>
  ...
  .dashboard > header {
    ...
    @apply border-r border-oh-blackout bg-oh-black;
    width: 70px;
  }

  .dashboard > aside {
    @apply flex-shrink-0 flex-grow-0;
    @apply border-r border-gray-300 bg-gray-200;
    width: 240px;
  }
  ...
  .aside-section-header {
    ...
    @apply px-2 py-2 bg-gray-300/[0.4];
  }
  ...
  .aside-section li {
    @apply flex justify-start items-center py-1 text-sm px-5;
  }
